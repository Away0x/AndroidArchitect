...
class HiCircleIndicator @JvmOverloads constructor(
    ...
    /** 指示点左右内间距 */
    private var mPointLeftRightPadding = HiDisplayUtil.dp2px(5f, context.resources)

    /** 指示点上下内间距 */
    private var mPointTopBottomPadding = HiDisplayUtil.dp2px(15f, context.resources)
